...
def pos_chk(x, y, size):
    '''
    possible_dirate if the coordinates specified (x and y) are within the maze.
...
def lazer_path(y, x, vx, vy, grid_matrix):
    ...
    if (vx, vy) == (1, -1):
        ...
        while True:
            try:
                ...
                elif grid_matrix[temp_y -1][temp_x + 1] == 30 :
                	a = incident__side(temp_y - 1,temp_x + 1, 30, grid_matrix)
                	print(a)
                	break
...
if __name__ == "__main__":
    ...
    lazer_path(y, x, vx, vy, grid_matrix)
