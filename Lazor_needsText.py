        ...
        for j in range(len(GRID)):
            ...
            for i in range(len(GRID[0])):
                ...
                if GRID[j][i] != "o":
                    ...
                    # updating positions of centroids of fixed reflect, refract and opaque blocks as 31,51 and 41.
                    if value == "A":
...
def block_change(matrix_copy, A, B, C):
    '''
    Computes all possible positions for movable blocks using permutation and combination
...
def laser_path(temp_y, temp_x, vx, vy, grid_matrix):
    ...
    Depends on starting points of laser, reflective, refractive and opaque blocks.
...
if __name__ == "__main__":
    ...
    Repeatedly checks if the game can be solved by inputing all possible combinations of movable blocks 
